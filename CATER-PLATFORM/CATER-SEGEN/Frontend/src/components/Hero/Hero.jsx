...
import bgImg from '../Hero/d-2.jpg';
    ...
    <div className='min-h-screen relative overflow-hidden'>
      <div
        ...
        style={{
          ...
          filter: 'blur(8px) brightness(50%)', // Adjust brightness to 70%
        }}
      ></div>
      <div className='min-h-screen flex justify-center items-center text-white relative z-10'>
        <div>
          <div className='space-y-4 p-3'>
            {/* <p className='md:text-4xl text-2xl'>Maha Spice</p> */}
          ...
          <div className='flex flex-wrap items-center gap-5'>
            <a href='/boxgenie'>
              <button className='px-7 py-3 rounded-lg bg-green font-bold uppercase'>Box - Genie ?</button>
            </a>
