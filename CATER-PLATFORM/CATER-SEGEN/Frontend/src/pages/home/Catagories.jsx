...
const categoryItems = [
    {id: 1, title: "Veg", description: "(4 Veg)", image: "/images/home/category/img1.png"},
    {id: 2, title: "Non-Veg", description: "(4 Non-veg)", image: "/images/home/category/img2.png"},
    // {id: 3, title: "Popular", despriction: "(6 popular)", image: "/images/home/category/img3.png"},
    {id: 3, title: "Browse All", description: "(14 Items)", image: "/images/home/category/img4.png"}
]
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto xl:px-24 px-4 py-16 ${isDarkMode ? 'dark' : ''}`}>
        <div className='text-center'>
            <p className='text-Green'>Customer Favorites</p>
